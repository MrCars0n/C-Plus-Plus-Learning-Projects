...
int main() {
    ...
    // Added print name and lab
    cout << "Carson Kramer -- CSCN 215 Programming Assignment 3 -- LRU Bufferpool" << endl << endl;
	...
	*/
	...
	//re-initialize the char array and get the next block of data
    initializeCharArray(10, data);
    bp->getBytes(data, 10, 16605);
    printChars(data, 10, 16605 / BLOCKSIZE);
    bp->printBufferBlockOrder();
    cout << "LRU Buffer is " << bp->getLRUBlockID() << endl << endl;
